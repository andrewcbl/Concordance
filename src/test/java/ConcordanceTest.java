...
public class ConcordanceTest {
    ...
    @Test
    public void testGetConcordance() throws Exception {
        String testStr = "A \"concordance\" is an alphabetical list of the words present in a text with a count of how\n" +
        ...
        Concordance concordance = new Concordance(testStr);

        ArrayList<String> output = concordance.getConcordance();
        assertEquals(71, output.size());
        List<String> expList = Arrays.asList(new String[]{
                "a            {6:0,0,0,1,1,1}",
                "alphabetical {1:0}",
                "an           {2:0,1}",
                "and          {4:0,1,2,3}",
        ...
        ArrayList<String> exp = new ArrayList<String>(expList);
